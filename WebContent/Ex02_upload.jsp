...
<%
	...
	//여기 까지 코드가 서버에 upload폴더에 파일이 저장 
	//D:\bit2021\WEB(Back)\WebLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebServlet_92_FileUpload
	//자료실
	//2가지
	//1. 서버에 파일 업로드 
	...
	*/
	...
	String file1 = (String)filenames.nextElement(); //filename1 
